...
flags.DEFINE_integer("n_steps", 100, "Number of steps in noise schedule")
flags.DEFINE_float("start_noise", 0.01, "The value in which to start the noise schedule")
flags.DEFINE_float("stop_noise", 1.05, "The value in which to stop the noise schedule")
...
def main(_):
    ...
    visualize_so3_density(jax.vmap(lambda q: SO3(q).as_matrix())(x_t),32);
